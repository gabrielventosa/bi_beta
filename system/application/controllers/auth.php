...
class Auth extends Controller
{
	...
	function captcha_check($code)
	{
		...
		if ($this->dx_auth->is_captcha_expired())
		{
			...
			$this->form_validation->set_message('captcha_check', 'El codigo de confirmaci&oacute;n ha expirado. Intente nuevamente.');			
			$result = FALSE;
		}
		elseif ( ! $this->dx_auth->is_captcha_match($code))
		{
			$this->form_validation->set_message('captcha_check', 'El codigo de confirmaci&oacute;n no coincide con la im&aacute;gen. Intente nuevamente.');			
			$result = FALSE;
		}
	...
	function recaptcha_check()
	{
		...
		if ( ! $result)
		{
			$this->form_validation->set_message('recaptcha_check', 'El codigo de confirmaci&oacute;n no coincide con la im&aacute;gen. Intente nuevamente.');
		}
