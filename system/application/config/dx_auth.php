...
$config['DX_website_name'] = 'InteligenciaMecanica Bussines Intelligence';
$config['DX_webmaster_email'] = 'webmaster@inteligenciamecanica.com';
...
$config['DX_change_password_success_view'] = 'auth/general_message_xml';
