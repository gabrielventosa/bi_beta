...
<link type="text/css" href="https://www.inteligenciamecanica.com/jquery-ui/css/ui-lightness/jquery-ui-1.7.2.custom.css" rel="stylesheet" />
<script type="text/javascript" src="https://www.inteligenciamecanica.com/jquery-ui/js/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="https://www.inteligenciamecanica.com/jquery-ui/js/jquery-ui-1.7.2.custom.min.js"></script>
<!--- Jquery--->
<!--- Style --->
<link rel="stylesheet" type="text/css" href="https://www.inteligenciamecanica.com/styles/edit_style.css"/>
<style type="text/css">
			/*demo page css*/
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#costohora').click(function() {
						$(this).val($('#gastos').val() / $('#disthrs').val());
						});
						
		$('#disthrs').click(function() {
						if(num_dist ==0){
							alert('No hay distribuidores definidos');
							}
						else{
							$(this).val(($('#realhrs').val()-$('#gpstime').val())/num_dist );
							}
						});
...
<?=form_hidden('id', $this->uri->segment(3));?>
	...
	<table>
		<tbody>
			...
			<tr><td>HORAS DISPONIBLES: </td><td><input type="text" id="hrsaval" class="input" name="hrsaval" value="<?=$row->hrsaval?>"/></td></tr>
			<tr><td>HORAS ALIMENTOS: </td><td><input type="text" id="hrsfood" class="input" name="hrsfood" value="<?=$row->hrsfood?>"/></td></tr>
			<tr><td>HORAS REALES: </td><td><input type="text" id="realhrs" class="input" name="realhrs" value="<?=$row->realhrs?>"/></td></tr>
			<tr><td>HORAS CON DISTRIBUIDOR: </td><td><input type="text" id="disthrs" class="input" name="disthrs" value="<?=$row->disthrs?>"/></td></tr>
			<tr><td>GASTOS: </td><td><input type="text" id="gastos" class="input" name="gastos" value="<?=$row->gastos?>"/></td></tr>
			<tr><td>COSTO/hora: </td><td><input type="text" id="costohora" class="input" name="costohora" value="<?=$row->costohora?>"/></td></tr>
		</tbody>
	</table>
