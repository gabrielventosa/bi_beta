...
<?=form_open('my_users/add');?>

	<table>
		<tbody>
			<tr><td>Usuario: </td><td><input type="text" name="username"  class="input" style ="text-transform: none;"/></td></tr>
			<tr><td>Email: </td><td><input type="text" name="email"  class="input" style ="text-transform: none;"/></td></tr>
		</tbody>
	</table>
