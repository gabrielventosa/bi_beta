...
<?=form_hidden('id', $this->uri->segment(3));?>
	...
	<table>
		<tbody>
			...
			<tr><td>DESDE: </td><td><input type="text" name="desde" id="date1" class="date_input" /></td></tr>
			<tr><td>HASTA: </td><td><input type="text" name="hasta" id="date2" class="date_input" /></td></tr>
			<tr><td>DIAS NO LABORADOS: </td><td><input type="text" id= "add_nday" class="input" name="dnlaboral" />
							<div id="nday_container">
							</div></td></tr>
			<tr><td>HORAS DE RECORRIDO: </td><td>
			<table style="border:0px; widht:100%">
			<tr><td><input type="text" id="gpstime" class="input" name="horascarretera" style="width:300px"/></td>
			...
			<tr><td>HORAS/DIA: </td><td><input type="text" id="horasdia" class="input" name="horasdia" /></td></tr>
			...
			<tr><td>GASTOS: </td><td><input type="text" id="gastos" class="input" name="gastos" /></td></tr>
			<tr><td>COSTO/hora: </td><td><input type="text" id="costohora" class="input" name="costohora" /></td></tr>
		</tbody>
	</table>
